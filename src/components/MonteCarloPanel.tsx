...
import {
  ...
  MonteCarloProgressStats,
  MonteCarloProgressContainer,
} from "./MonteCarloProgress";
...
export const MonteCarloPanel = memo(function MonteCarloPanel({
  heading,
  title,
  description,
  lineupBasicIds,
                        ...
                        {scenarioOptions.map((scenario) => {
                          ...
                          return (
                            <button
                              ...
                              onClick={() =>
                                onSelectedScenarioChange(scenario.id)
                              }
                        ...
                        <div className="grid grid-cols-4 items-stretch gap-2 sm:gap-2.5">
                          {PRESET_BATCH_SIZES.map((batchSize) => (
                            <button
                              ...
                              onClick={() =>
                                onRunBatch(selectedScenarioId, batchSize)
                              }
                ...
                {isRunning ? (
                  <div className="xl:col-span-2">
                    <div className="rounded-[1.9rem] bg-slate-100/70 px-5 py-4 ring-1 ring-slate-200/80 dark:bg-slate-900/45 dark:ring-slate-800/80 md:px-6 md:py-5">
                      ...
                      <MonteCarloProgressBar
                        extremePerformanceEnabled={extremePerformanceEnabled}
                      />
                    </div>
                  </div>
                ) : null}
