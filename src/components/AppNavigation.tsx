...
export function AppNavigation({
  ...
  return (
    <nav className="sticky top-0 z-50 border-b border-slate-200/90 bg-white/85 backdrop-blur-md dark:border-slate-800/90 dark:bg-slate-950/85">
      <div className="mx-auto flex w-full max-w-[1920px] flex-nowrap items-center justify-between gap-2 overflow-x-auto px-2 py-2 sm:gap-3 sm:px-4 md:px-8 lg:px-12 xl:px-14 2xl:px-24 [&::-webkit-scrollbar]:hidden [-ms-overflow-style:none] [scrollbar-width:none]">
        ...
        <div className="flex shrink-0 items-center gap-1.5 sm:gap-2">
          <div className="grid min-w-0 grid-cols-3 gap-0.5 rounded-full border border-slate-200 bg-slate-100/90 p-0.5 shadow-inner shadow-slate-900/10 dark:border-slate-800 dark:bg-slate-900/80 dark:shadow-slate-950/50 sm:gap-1 sm:p-1">
            <button
              type="button"
